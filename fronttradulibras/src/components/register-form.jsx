...
export function RegisterForm({ className, ...props }) {
  return (
    <div className={cn('flex flex-col gap-6 text-xs', className)} {...props}>
      <Card className="overflow-hidden p-0 bg-[#f3f3f3] border border-[#3B3F46]/30 shadow-xl">
          ...
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-3">
              <div className="flex flex-col items-left text-left">
                ...
                <p className="text-sm text-[#3B3F46]">Faça o seu registro</p>
              </div>
      ...
      <div className="*:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4 text-[#3B3F46]">
